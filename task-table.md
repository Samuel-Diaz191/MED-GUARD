...
|---|---|---|---|---|---|---|---|
| `ecg_sample` (producer) | 1 | 8 | 50 ms (20 Hz) | 50 ms | *[fill in]* | *[fill in]* | *[fill in]* |
| `arrhythmia_decision` (consumer) | 1 | 8 | event-driven (queue receive, 200 ms timeout) | — | *[fill in]* | *[fill in]* | *[fill in]* |
| `cycle_coordinator` | 1 | 9 | event-driven (event group rendezvous) | — | *[fill in]* | *[fill in]* | *[fill in]* |
...
```
U(ecg_sample) = WCET+30% / Period = [fill in] / 50 ms = [fill in]
```
